...
subtitle: "Influence of Gender and Race on job application callbacks"
format: pdf
...
#  metric_name = c("Sensitivity", "precision", "recall", "f1-score"),
#  value = c(confusion_matrix$byClass[1], 0.78, 0.92, 0.84)
#)
